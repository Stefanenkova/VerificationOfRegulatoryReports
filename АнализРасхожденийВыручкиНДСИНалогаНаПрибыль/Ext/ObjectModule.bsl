...
// Процедура формирует отчет и возвращает в виде табличного документа.
//
// Параметры:
//  - Параметры - Структура - Обязательные ключи - Организация, МассивСубконтоПДР и Период.
//  - АдресРезультата - УникальныйИдентификатор - Адрес, где будет храниться результат.
Процедура СформироватьОтчет(Параметры, АдресРезультата) Экспорт
