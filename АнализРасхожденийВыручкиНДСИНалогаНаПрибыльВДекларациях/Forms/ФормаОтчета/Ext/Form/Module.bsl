...
Процедура ВыбратьПериод(Команда)
	...
	ОткрытьФорму("ВнешнийОтчет.АнализРасхожденийВыручкиНДСИНалогаНаПрибыльВДекларациях.Форма.ВыборПериодаНарастающимИтогом",
...
Процедура Настройка(Команда)
	...
	ОткрытьФорму("ВнешнийОтчет.АнализРасхожденийВыручкиНДСИНалогаНаПрибыльВДекларациях.Форма.ФормаНастроек",
