Функция СформироватьОтчет(Организация, Период) Экспорт
	...
	ТабличныйДокумент.Вывести(Область);
	ВывестиЗначенияПоказателей(Макет, Периоды, "ПереходящиеРазницы", ТаблицаСверкиДанных, ТабличныйДокумент);
	...
	ТабличныйДокумент.Вывести(Область);
	ВывестиЗначенияПоказателей(Макет, Периоды, "НеизменныеРазницы", ТаблицаСверкиДанных, ТабличныйДокумент);
	
	Область = Макет.ПолучитьОбласть("СтрокаНижнийУровень|Показатель");
	Область.Параметры.Показатель = "Возвраты товаров поставщику";
	ТабличныйДокумент.Вывести(Область);
	ВывестиЗначенияПоказателей(Макет, Периоды, "ВозвратПоставщику", ТаблицаСверкиДанных, ТабличныйДокумент, Истина);
	
	Область = Макет.ПолучитьОбласть("СтрокаНижнийУровень|Показатель");
	Область.Параметры.Показатель = "Возвраты товаров от покупателей";
	ТабличныйДокумент.Вывести(Область);
	ВывестиЗначенияПоказателей(Макет, Периоды, "ВозвратОтПокупателя", ТаблицаСверкиДанных, ТабличныйДокумент, Истина);
